<div class="modal hide fade" id="modal_pics" style="width:440px;">
	...
	<div class="modal-footer">
		<form method="post" action="/upload/loadimage" enctype="multipart/form-data" class="form-inline row-fluid">
			<input type="file" placeholder="<?=$picture_placeholder;?>" class="span8" size="46" name="userfile" id="userfile" />
			<input type="text" name="comment" placeholder="<?=$picture_caption;?>" class="span12" id="upload_cmnt" maxlength="200" title="<?=$picture_title;?>">
			<button type="submit" class="btn btn-primary span12" style="margin-left:0px;margin-top:10px;"><?=$upload_label;?></button>
			<input type="hidden" name="upload_user" value="frontend_user">
			<? if (isset($mapset)) { print '<input type="hidden" name="upload_from" value="page/map/'.$mapset;'">';}?>
...
<div class="modal hide fade" id="langSelector" style="width:440px;">
	...
	<div class="modal-body">
		<form method=post action="/map/set_language">
			<button type="submit" class="btn btn-large langSubmitter" name="lang" value="ru" title="Russian"><img src="/images/flag_ru.png" width="32" height="32" border="0" alt=""></button>
