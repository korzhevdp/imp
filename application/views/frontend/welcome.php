...
<body>
	...
	<div id="searchForm">
		...
		<div id="searchData">
			<div class="objectGroup" title="Индивидуальное предпринимательство">
				...
				<div class="objectType" ref="62">Дом</div>
				<div class="objectType" ref="59">Коттедж</div>
				<div class="objectType" ref="56">Квартира</div>
				<div class="objectType" ref="60">Комната</div>
			</div>
			<div class="objectGroup" title="Индустриальные объекты">
				<div class="objectGroupHeader">Гостиницы</div>
				<div class="objectType" ref="58">Мини-отель</div>
				<div class="objectType" ref="57">Гостиница</div>
				<div class="objectType" ref="61">Пансионат</div>
				<div class="objectType" ref="13">Хостел</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function filldata(ref){
			if (selectedTypes[ref] === undefined) {
				selectedTypes[ref] = 1;
				return true;
			}
			delete(selectedTypes[ref]);
			return true;
		}

		$(".objectType").click(function() {
			var ref = $(this).attr("ref");
			$(".objectType").removeClass("selectedType");
			filldata(ref);
			//alert(2)
			for (a in selectedTypes) {
				//alert(ref);
				$(".objectType[ref=" + a + "]").addClass("selectedType");
			}
		});
