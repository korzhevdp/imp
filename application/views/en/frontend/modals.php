<div class="modal hide fade" id="modal_pics" style="width:440px;">
	...
	<div class="modal-footer">
		<form method="post" action="/upload/loadimage" enctype="multipart/form-data" class="form-inline row-fluid">
			...
			<input type="text" name="comment" placeholder="Caption for the picture..." class="span12" id="upload_cmnt" maxlength="200" title="The photo caption. Can be edited in the Photo Section." />
