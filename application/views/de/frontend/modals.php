<div class="modal hide fade" id="modal_pics" style="width:440px;">
	...
	<div class="modal-footer">
		<form method="post" action="/upload/loadimage" enctype="multipart/form-data" class="form-inline row-fluid">
			<input type="file" placeholder="<?=$modals['picture_placeholder'];?>" class="span8" size="46" name="userfile" id="userfile" />
			<input type="text" name="comment" placeholder="<?=$modals['picture_caption'];?>" class="span12" id="upload_cmnt" maxlength="200" title="<?=$modals['picture_title'];?>">
			<button type="submit" class="btn btn-primary span12" style="margin-left:0px;margin-top:10px;"><?=$modals['upload_label'];?></button>
