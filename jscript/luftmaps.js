...
function init() {
	...
	map = new ymaps.Map(
		...
		{projection: config.proj, maxZoom: config.maxZoom, minZoom: config.minZoom, suppressMapOpenBlock: true, yandexMapDisablePoiInteractivity : true, yandexMapAutoSwitch: false },
		{}
	);
