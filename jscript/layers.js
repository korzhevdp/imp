...
layerTypes = {
	...
	29: {
		func  : function () {return new ymaps.Layer(function (tile, zoom) {return layerTypes[29].folder + zoom + '/' + tile[0] + '/' + (dX[zoom] - tile[1]) + '.png';}, {tileTransparent: 1, zIndex:1000});},
		folder: "http://luft.korzhevdp.com/maps/novodvinsk/base/",
		label : "base#nov",
		name  : "Архбумстрой - Новодвинск",
		localLayerID: 1,
		layers: ['yandex#satellite', "base#nov"]
	},
	30: {
		func  : function () {return new ymaps.Layer(function (tile, zoom) {return layerTypes[30].folder + zoom + '/' + tile[0] + '/' + (dX[zoom] - tile[1]) + '.png';}, {tileTransparent: 1, zIndex:1000});},
		folder: "http://luft.korzhevdp.com/maps/novodvinsk/hr/",
		label : "hr#nov",
		name  : "Архбумстрой - Новодвинск. Высокое разрешение",
		localLayerID: 1,
		layers: ['yandex#satellite', "base#nov", "hr#nov"]
	},
	31: {
		func  : function () {return new ymaps.Layer(function (tile, zoom) {return layerTypes[31].folder + zoom + '/' + tile[0] + '/' + (dX[zoom] - tile[1]) + '.png';}, {tileTransparent: 1, zIndex:1000});},
		folder: "http://luft.korzhevdp.com/maps/nm/plan/",
		label : "nm#plan",
		name  : "Нарьян-Мар. План лесозавода",
		localLayerID: 4,
		layers: ['yandex#satellite', "nm#plan"]
	}
}